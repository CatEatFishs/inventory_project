...
//剩余库存页面
class ResidueInventoryPage extends StatefulWidget {
  @override
  _ResidueInventoryPageState createState() => _ResidueInventoryPageState();
}

class _ResidueInventoryPageState extends State<ResidueInventoryPage>
                ...
                child: TabBarView(
                  ...
                  children: myTabs
                      ...
                      .map((index, model) => MapEntry(
                          index, ResidueInventoryList(goodName: model.text)))
                      .values
                      .toList(),
                ))
          ],
